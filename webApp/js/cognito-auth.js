...
(function scopeWrapper($) {
    ...
    BabyActivityTracker.signOut = function signOut() {
        userPool.getCurrentUser().signOut();
        window.location.href = 'index.html';
        };

    BabyActivityTracker.authToken = new Promise(function fetchCurrentAuthToken(resolve, reject) {
    ...
    $(function onDocReady() {
        ...
        $('#signOut').click(BabyActivityTracker.signOut);
    });
